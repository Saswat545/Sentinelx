            ...
            <div className="col-span-2">
              ...
              <div className="flex gap-3">
                {socialLinks.map((social) => (
                  <a key={social.name} href={social.href} className="w-10 h-10 rounded-full bg-gray-100 hover:bg-[#6D001A]/10 flex items-center justify-center text-gray-400 hover:text-[#6D001A] transition-all duration-200" aria-label={social.name}>
                    {social.icon}
                  </a>
                ))}
              </div>
